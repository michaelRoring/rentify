...
const Icon = ({name, size}) => {
  ...
  switch(name) {
    ...
    case 'icon-shopping-cart':
			return <Image src={IconShoppingCart} width={size} height={size} alt={name}/>
			break;
    case 'icon-community':
			return <Image src={IconCommunity} width={size} height={size} alt={name}/>
			break;
    case 'icon-notification':
			return <Image src={IconNotification} width={size} height={size} alt={name}/>
			break;
		case 'icon-warning':
